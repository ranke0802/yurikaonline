...
class Game {
    ...
    initMonstersAndHistory() {
        ...
        this.updateHistory = [
            {
                version: 'v1.86', date: '2026-01-23', title: 'Premium Status Icons',
                logs: [
                    '몬스터 상태 아이콘 리디자인: 투박한 이모지와 사각형 프레임을 제거하고, 몬스터 발밑에 핏하게 붙는 커스텀 그래픽 배지 도입',
                    '전문적인 시각 효과: 시얀색 광채의 번개와 따뜻한 그라데이션의 불꽃 아이콘을 직접 캔버스에 렌더링하여 게임 아트와 조화'
                ]
            },
            {
