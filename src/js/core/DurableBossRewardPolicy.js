    ...
    1: {
        ...
        items: {
            magic_staff: {
                ...
                description: '',
                icon: '🪄',
                iconPath: 'src/assets/items/magic_staff_inventory.png',
                rarity: 'boss',
            ...
            tidal_staff: {
                ...
                icon: '🔱',
                iconPath: 'src/assets/items/tidal_staff.png',
                rarity: 'boss',
                enhancementRuleSet: 'weapon_standard_1_to_10',
            ...
            storm_staff: {
                ...
                icon: '⚡',
                iconPath: 'src/assets/items/storm_staff.png',
                rarity: 'boss',
                enhancementRuleSet: 'weapon_standard_1_to_10',
            ...
            astral_staff: {
                ...
                icon: '🌌',
                iconPath: 'src/assets/items/astral_staff.png',
                rarity: 'boss',
                enhancementRuleSet: 'weapon_standard_1_to_10',
